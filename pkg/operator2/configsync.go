...
func syncOrDie(syncFunc func(dest, src resourcesynccontroller.ResourceLocation) error, dest, src string) {
	...
	if err := syncFunc(resourcesynccontroller.ResourceLocation{Namespace: targetName, Name: dest}, resourcesynccontroller.ResourceLocation{Namespace: ns, Name: src}); err != nil {
		panic(err)
	}
}
