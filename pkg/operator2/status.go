...
func setDegradedTrue(operatorConfig *operatorv1.Authentication, reason, message string) {
	...
	v1helpers.SetOperatorCondition(&operatorConfig.Status.Conditions, operatorv1.OperatorCondition{Type: operatorv1.OperatorStatusTypeDegraded, Status: operatorv1.ConditionTrue, Reason: reason, Message: message})
}
func setDegradedFalse(operatorConfig *operatorv1.Authentication) {
	_logClusterCodePath()
	defer _logClusterCodePath()
	v1helpers.SetOperatorCondition(&operatorConfig.Status.Conditions, operatorv1.OperatorCondition{Type: operatorv1.OperatorStatusTypeDegraded, Status: operatorv1.ConditionFalse})
}
